...
suite('Functional Tests', () => {
  test('POST /api/check, it correctly handles request containing all fields', async () => {
  ...
  test('POST /api/check, it correctly handles request with single placement conflict', async () => {
    const response = await chai
      .request(server)
      .post('/api/check')
  ...
  test('POST /api/check, it correctly handles request with multiple placement conflicts', async () => {
    const response = await chai
      .request(server)
      .post('/api/check')
  ...
  test('POST /api/check, it correctly handles request with all placement conflicts', async () => {
    const response = await chai
      .request(server)
      .post('/api/check')
  ...
  test('POST /api/check, it correctly handles request with missing required fields', async () => {
    const response = await chai
      .request(server)
      .post('/api/check')
  ...
  test('POST /api/check, it correctly handles request with invalid characters', async () => {
    const response = await chai
      .request(server)
      .post('/api/check')
      .send({
  ...
  test('POST /api/check, it correctly handles request with incorrect length', async () => {
    const response = await chai
      .request(server)
      .post('/api/check')
      .send({
  ...
  test('POST /api/check, it correctly handles request with invalid placement coordinate', async () => {
    const response = await chai
      .request(server)
      .post('/api/check')
  ...
  test('POST /api/check, it correctly handles request with invalid placement value', async () => {
    const response = await chai
      .request(server)
      .post('/api/check')
  ...
  test('POST /api/solve, it correctly handles the request with a valid puzzle string', async () => {
    const response = await chai
      .request(server)
      .post('/api/solve')
  ...
  test('POST /api/solve, it correctly handles the request with the missing puzzle string', async () => {
  ...
  test('POST /api/solve, it correctly handles the request with the puzzle containing invalid characters', async () => {
    const response = await chai
      .request(server)
      .post('/api/solve')
  ...
  test('POST /api/solve, it correctly handles the request with the incorrect length puzzle', async () => {
    const response = await chai
      .request(server)
      .post('/api/solve')
  ...
  test('POST /api/solve, it correctly handles the request with the puzzle that cannot be solved', async () => {
    const response = await chai
      .request(server)
      .post('/api/solve')
